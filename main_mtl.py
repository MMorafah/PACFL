...
from src.client.client_mtl import *
...
for idx in range(args.num_users):
    ...
    clients.append(Client_MTL(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep, 
               args.lr, args.momentum, args.device, omega, train_dl_local, test_dl_local))
...
for iteration in range(args.rounds):
    ...
    for count, idx in enumerate(idxs_users):
        ...
        loss = clients[idx].train(count, W.clone(), is_print=False)
